...
set autocommit=0  
select \* from tab\_no\_index where id = 1;

set autocommit=0  
select \* from tab\_no\_index where id =2
...
set autocommit=0  
select \* from tab\_with\_indexwhere id = 1;

set autocommit=0  
select \* from tab\_with\_indexwhere id =2
...
select \* from tab\_with\_index where id = 1 and name=’4’ for update  
